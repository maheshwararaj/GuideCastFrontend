...
const Display = () => {
  ...
  useEffect(() => {
    if (isAlbum) {
      ...
      displayRef.current.style.background = "#ffffff";
    }
  })

  return (
    <div ref={displayRef} className='w-[100%] m-2 px-6 pt-4 rounded bg-white text-black overflow-auto lg:w-[75%] lg:ml-0 box-shadow-dark'>
      <Routes>
